...
using Nettestone.Infrastructure;
using Nettestone.Infrastructure.Models;

namespace Nettestone;
...
public class SeedDevelopmentData
{
    ...
    {
        var context = serviceProvider.GetRequiredService<NettestoneDbContext>();
